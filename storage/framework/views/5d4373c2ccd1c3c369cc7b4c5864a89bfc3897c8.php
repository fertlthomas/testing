            ...
            <table>
                ...
                <?php foreach($spielers as $spieler): ?>
                    <tr>
                        ...
                        <form action="<?php echo e(url('"/Teams/".$spieler->team_id."/Spieler/Update/'.$spieler->id)); ?>" method="get">
                        ...
                        <form action="<?php echo e(url("/Teams/".$spieler->team_id."/Spieler/deleting/".$spieler->id)); ?>" method="post">
                            <?php echo e(csrf_field()); ?>
